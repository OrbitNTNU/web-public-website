...
const Framsat1Page = () => {
    return (
      ...
      linear-gradient(
        135deg,
        var(--color-framsat-blue) 0%,
        var(--color-framsat-yellow) 10%,
        var(--color-framsat-red) 100%
      )
      `,
                    ...
                    <div className="absolute flex flex-col items-center justify-center inset-0 text-center">
                      ...
                      <div className="relative">
                        <div
                          ...
                          style={{
                            background: `radial-gradient(circle at center, var(--color-framsat-yellow) 0%, var(--color-framsat-blue) 60%, transparent 100%)`,
                          }}
                        />
                        <Image
                          src="/patches/FS_1.png"
                          alt="SelfieSat Patch"
                          width={300}
                          height={300}
