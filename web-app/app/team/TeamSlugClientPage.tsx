...
export default function TeamSlugClientPage({ teamDocument, team }: TeamSlugClientPageProps) {
                ...
                {teamDocument.sections?.map((section) => {
                    switch (section._type) {
                        ...
                        case "triImageCollage":
                            return (
                                <span key={section._key}>TriImageCollage</span>
                            )

                        case "flowingTriImageCollage":
                            return (
                                <span key={section._key}>FlowingTriImageCollage</span>
                            )
